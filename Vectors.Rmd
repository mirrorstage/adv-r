...
I'll often use __scalar__ to refer to individual values, like `TRUE` or `1`. This is a bit of a simplification: they're really vectors of length 1. However, scalar is a convenient word, even if it's not completely true to the underlying relatively.
